...
export class Lighting {
  constructor(scene) {
    ...
    this._kf = [
      ...
      { t: 0.00, sky: 0x1d2c50, fog: 0x3e4c6c, sun: 0x9aa8d8, si: 0.55, hi: 0.78, g: 0x2b3654 },
      { t: 0.20, sky: 0x44567c, fog: 0x56668a, sun: 0x9aa0d0, si: 0.70, hi: 0.88, g: 0x3a4258 },
      ...
      { t: 0.88, sky: 0x2e3a5e, fog: 0x49567a, sun: 0x93a0d4, si: 0.58, hi: 0.78, g: 0x2c3658 },
    ].map((k) => ({
  ...
  _apply() {
    ...
    if (this.scene.fog) {
      ...
      // clear nights: push the fog out after dark so the meadow + tree stay
      // crisp under the moon, while the far hills still fade into the mist
      const night = 1 - this.dayness;
      this.scene.fog.near = 32 + night * 18; // day 32 → night 50
      this.scene.fog.far = 72 + night * 12; // day 72 → night 84
    }
  }
}
